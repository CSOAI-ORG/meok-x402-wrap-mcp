...
[![MCP Scorecard: 90/100](https://img.shields.io/badge/proofof.ai-90%2F100-5b21b6)](https://proofof.ai/scorecard/meok-x402-wrap-mcp.html)
...
```json
{
  "mcpServers": {
    "meok-x402-wrap-mcp": {
      "command": "uvx",
      "args": ["meok-x402-wrap-mcp"]
    }
  }
}
```

Or: `pip install meok-x402-wrap-mcp` then run the `meok-x402-wrap-mcp` command (stdio transport).
